...
namespace Pommel.Reversi.Presentation.Model.System
{
    ...
    {
        Task LoadSceneAsync(IScene scene, ActionCommand<DiContainer> bind = default);
    ...
    public sealed class TransitionModel : ITransitionModel
    {
        ...
        public async Task LoadSceneAsync(IScene scene, ActionCommand<DiContainer> bind = default) =>
